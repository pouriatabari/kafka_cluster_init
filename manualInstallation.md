...
listeners=PLAINTEXT://kafka-01:9091

# Listener name, hostname and port the broker will advertise to clients.
# If not set, it uses the value for "listeners".
advertised.listeners=PLAINTEXT://kafka-01:9091
...
zookeeper.connect=192.168.27.201:2181,192.168.27.202:2181,192.168.27.203:2181
...
#   EXAMPLE:
#     listeners = PLAINTEXT://your.host.name:9092
listeners=PLAINTEXT://kafka-03:9093

# Listener name, hostname and port the broker will advertise to clients.
# If not set, it uses the value for "listeners".
advertised.listeners=PLAINTEXT://kafka-03:9093
...
EOF
```
12. Start the zookepeeper and servers(brokers):
```
